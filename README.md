...
country <- get_country()
#> Reading layer `moz_admbnda_adm0_ine_20190607' from data source `/tmp/Rtmp3aLm0l' using driver `ESRI Shapefile'
...
#> Reading layer `moz_admbnda_adm1_ine_20190607' from data source `/tmp/Rtmp3aLm0l' using driver `ESRI Shapefile'
...
#> Reading layer `moz_admbnda_adm2_ine_20190607' from data source `/tmp/Rtmp3aLm0l' using driver `ESRI Shapefile'
...
postos <- get_posts()
#> Reading layer `moz_admbnda_adm3_ine_20190607' from data source `/tmp/Rtmp3aLm0l' using driver `ESRI Shapefile'
